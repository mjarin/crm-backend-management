...
class Good2GoController extends Controller
{

public function good2GoDeliveryReport(){
    return view('pages.courierWiseOrders.Good2Go.good2go-delivery-report');
}

public function viewGood2GoDeliveryReportStep1(Request $request){
    $from_date =$request->fromdate;
    $to_date =$request->todate;
    $records = Order::whereBetween('delivery_date', array($from_date, $to_date))
                      ->where('delivery_man','=','Good2Go')
                      ->get();
    return view('pages.courierWiseOrders.Good2Go.Good2Go-delivery-report-step1',compact('records','from_date','to_date'));

}

public function Good2GoDeliveryReportStep2(Request $request){
    $from_date =$request->fromdate;
    $to_date =$request->todate;
    $records = Order::whereBetween('delivery_date', array($from_date, $to_date))
                      ->where('delivery_man','=','Good2Go')
...
public function Good2GoDeliveryReportDateWise($date){
    ...
    return view('pages.courierWiseOrders.Good2Go.good2go-delivery-date-wise',compact('records'));   
}
