...
public function onHoldOrders(){
    ...
    return view('pages.order.OnHoldOrders.on-hold-orders',compact('orders','couriers'));
   }
...
public function viewOnHoldOrderDetails($id){
    ...
    return view('pages.order.OnHoldOrders.single-on-hold-order',compact('orders'));
}
...
public function editOnHoldOrderStep2($id){
  $delivery_man = DeliveryMan::all();
  $order =Order::find($id);
  return view('pages.order.OnHoldOrders.update-on-hold-order-step2',compact('order','delivery_man'));
}


public function updateOnHoldOrderStep2(Request $request){
