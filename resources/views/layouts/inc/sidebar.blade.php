            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{url('/remarking-orders')}}" class="nav-link">
                                <i class="fa fa-circle-o nav-icon"></i>
                                <p>Remarks Order</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('pathao-report') }}" class="nav-link">
                                <i class="fa fa-circle-o nav-icon"></i>
                                <p>Pathao</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/paperfly-delivery-report') }}" class="nav-link">
                                <i class="fa fa-circle-o nav-icon"></i>
                                <p>Paperfly</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/redEx-delivery-report') }}" class="nav-link">
                                <i class="fa fa-circle-o nav-icon"></i>
                                <p>RedEx</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/good2Go-delivery-report') }}" class="nav-link">
                                <i class="fa fa-circle-o nav-icon"></i>
                                <p>Good2Go</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/gogobangla-delivery-report') }}" class="nav-link">
                                <i class="fa fa-circle-o nav-icon"></i>
                                <p>Go Go Bangla</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/durbinx-delivery-report') }}" class="nav-link">
                                <i class="fa fa-circle-o nav-icon"></i>
                                <p>DurbinX</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/steadfat-delivery-report') }}" class="nav-link">
                                <i class="fa fa-circle-o nav-icon"></i>
                                <p>Steadfat</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="{{url('/seller-advance-payment')}}" class="nav-link">
                        <i class="nav-icon fa fa-file"></i>
                        <p class="">
