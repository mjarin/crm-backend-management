<div class="modal fade" id="po-update-purchase-status-id" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 650px!important;" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body px-5 py-5">
          <form id="form" class="form-horizontal" action="{{url('po-update-purchase-status')}}" method="POST">
              @csrf
              @method('PUT')  
