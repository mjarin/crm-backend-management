    ...
    <div class="modal-dialog" style="max-width: 800px!important;" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold">Order Code : <span class="font-weight-bold"
                        id="ordercode"></span></h5>
            ...
            <div class="modal-body px-5">
                <form id="form" class="form-horizontal" action="{{ url('update-pending-order') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="seller_coupon_discount"
                                id="seller_coupon_discount">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="customer_delivery_charge"
                                id="customer_delivery_charge">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="circle_delivery_charge"
                                id="circle_delivery_charge">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="collected_amount" id="collected_amount"
                                placeholder="1170.00">
                        </div>
                    </div>
