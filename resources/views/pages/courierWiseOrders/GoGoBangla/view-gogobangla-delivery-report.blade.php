...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Go Go Bangla Delivery Report</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <form method="GET" action="{{ url('search-good2go-report-by-date-step2') }}">
                                <div class="row">
                                ...
                                <tbody>
                                    @foreach ($records as $order)
                                        <tr>
                                            ...
                                            <td>2</td>
                                            <td><a href="{{ url('view-gogobangla-report-date-wise/' . $order->delivery_date) }}">
                                                    <button class="btn btn-warning btn-sm btn-flat text-white"
                                                        style="background:#FF8C00!important;">
