...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Paperfly Delivery Report</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="card-header bg-white">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <form method="GET" action="{{ url('search-paperfly-report-by-date-step2') }}">
                                <div class="row">
                                ...
                                <tbody>
                                    @foreach ($records as $order)
                                        <tr>
                                            ...
                                            <td>2</td>
                                            <td><a href="{{url('view-paperfly-report-date-wise/'.$order->delivery_date)}}">
