                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-white">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" method="POST" action="{{url('update-customer-address-no-status')}}">
                                    @csrf
                                    @method('PUT') 
                                    ...
                                    <div class="form-group row">
                                        <label for="employee" class="col-sm-3 col-form-label text-right font-weight-normal">Customer Delivery
                                            Charge</label>
                                    ...
                                    <div class="form-group row">
                                        <label for="" class="col-sm-3 col-form-label text-right font-weight-normal">Advance
                                            Payment</label>
