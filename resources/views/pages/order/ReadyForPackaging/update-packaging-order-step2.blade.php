                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" method="POST"
                                    action="{{ url('update-packaging-order-step2') }}">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group row">
                                        <label for="" class="col-sm-3 col-form-label text-right">Total Delivery
                                            Charge</label>
                                        <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label for="employee" class="col-sm-3 col-form-label text-right">Delivery
                                            Date</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="" class="col-sm-3 col-form-label text-right">Delivery
                                            Status</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="edit_payment"
                                            class="col-sm-3 control-label font-weight-bold text-right">Payment
                                            Status</label>
                                        <div class="col-sm-9">
