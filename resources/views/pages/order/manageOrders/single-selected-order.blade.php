        ...
        {{-- <div class="col-md-12"> --}}
          <div class="card">
            <div class="bg-white card-header">
                <div class="py-2">
                    <button type="button" class="btn btn-success update-purchase-status-btn" value="{{ $selected_order['0']['id'] }}" 
                    data-toggle="modal" data-target="#purchase_status_modal_id"><i class="fa fa-plus-circle">
            ...
            <th style="width:5%">SKU</th>
                ...
                <tbody>
                   ...
                   <tr> 
                    ...
                    <td><img src="{{asset('images/p-1.jpg')}}" alt="product_img"  style="width=120px; max-width:100px;"></td>
                    <td>
                    ...
                    <td>
{{-- Update Button --}}
<button class="btn btn-success btn-sm edit-selected-order-deatails" value="{{$order->id}}" data-toggle="modal" 
data-target="#selected_order_details_id"><i class="fa fa-edit"></i>&nbsp;&nbsp;&nbsp;Update</button><br>
{{-- Returned Button --}}
<button class="btn btn-info btn-sm  returned-selected-order-btn" value="{{$order->id}}" data-toggle="modal" 
data-target="#selected_order_returned_id"><i class="fa fa-edit"></i>&nbsp;&nbsp;&nbsp;Returned</button> 
{{-- Purchased Button --}}
<a href="{{url('purchased-selected-order/'.$order->id)}}" target="”_blank”"><button class="btn btn-primary btn-block"><i class="fa fa-edit"></i>&nbsp;&nbsp;&nbsp;Purchased</button></a>
