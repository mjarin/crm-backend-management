            ...
            <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body scrollable">
                        <table class="table table-bordered data_table_onHold ">
                            <thead>
                                <tr role="row">
                                ...
                                @foreach ($orders as $order)
                                    <tr role="row">
                                        ...
                                        <td>{{-- Toools td starts --}}
                                            {{-- Update button....................................................... --}}
                                            <button type="button"
                                                class="btn btn-success on-hold-order-btn btn-small btn-flat border-radius-none "
                                                value="{{ $order->id }}" data-toggle="modal"
                                                data-target="#on-hold-order-modal-id"><i
                                                    class="fa fa-edit"></i></button><br>
                                            {{-- View button....................................................... --}}
                                            <a href="{{ url('view-on-hold-order-details/'.$order->id) }}">
                                                <button
                                                    class="btn btn-warning btn-small btn-flat border-radius-none  text-white"><i
                                                        class="fa fa-eye"></i></button>
                                            </a>
                                            <br>
                                            {{-- delete//trash button....................................................... --}}
                                            <a href="#">
                                                <button class="btn btn-danger btn-small btn-flat border-radius-none "
                                            ...
                                            <div class="dropdown-menu">
                                                <button class="btn btn-info " type="button" data-toggle="dropdown"><i
                                                        class="fa fa-file"></i>
                                                    <span class="caret"></span></button>
                                            </div>
                                            <div class="btn-group">
                                                <button type="button"
                                                    class="btn btn-info  btn-small btn-flat border-radius-none "
                                                ...
                                                <li><a href="{{url('edit-order-on-hold-order/'.$order->id)}}" target="”_blank”" 
                                                class="text-dark ml-2">Update Order</a></li>
                                                </div>
                                            </div>{{-- End of file div --}}
                                        </td>{{-- Toools td End --}}
                                    </tr>
