                ...
                <div class="card">
                    <div class="card-header bg-white">
                        @foreach ($orders as $order)
                            <button type="button" class="btn btn-success underReviewOrder-purchase-status-btn"
                                data-toggle="modal" value="{{ $order->id }}"
                                data-target="#update-purchase-status-underReviewOrder">
                            ...
                            <tbody>
                                @foreach ($orders as $order)
                                    <tr>
                                        ...
                                        <td>
                                            {{-- Update Button --}}
                                            <button class="btn btn-success btn-sm btn-flat under-review-order-deatail-btn"
                                                value="{{ $order->id }}" data-toggle="modal"
                                                data-target="#under-review-order-deatail-btn"><i
                                                    class="fa fa-edit"></i>&nbsp;&nbsp;&nbsp;Update</button><br>
                                            {{-- Returned Button --}}
                                            <button class="btn btn-info btn-sm btn-flat returned-under-review-order-btn"
                                                value="{{ $order->id }}" data-toggle="modal"
                                                data-target="#under-review-order-returned-id"><i
                                                    class="fa fa-edit"></i>&nbsp;&nbsp;&nbsp;Returned</button><br>
                                            {{-- Purchased Button --}}
                                            <a href="{{ url('purchased-under-review-order/' . $order->id) }}"
                                                target="”_blank”"><button class="btn btn-primary btn-flat"><i
                                                        class="fa fa-edit"></i>&nbsp;&nbsp;&nbsp;Purchased</button></a> <br>
                                            <button class="btn btn-danger btn-sm btn-flat delete"><i
                                                    class="fa fa-trash"></i>&nbsp;&nbsp;&nbsp;&nbsp;Delete</button>
                                            <a href="#" target="”_blank”"><button class="btn-info"><i
                                                        class="fa fa-edit"></i> Processed</button></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
